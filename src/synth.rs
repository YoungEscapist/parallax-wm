//! Синтетический ввод для харнесса: мышь и клавиатура «изнутри» parallax.
//!
...
//!
//! **Почему не звать `pointer.motion` напрямую.** Половина поведения parallax
...
/// Колесо мыши. Источник — именно `Wheel`, а не `Finger`: в parallax от источника
...
impl PointerAxisEvent<Синтетика> for Колесо {
    // 15 логических пикселей на зубец — то же соотношение, которым parallax сам
