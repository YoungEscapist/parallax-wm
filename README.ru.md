...
<td width="50%"><img src="assets/shots/canvas.jpg" alt="Те же окна плавающими на холсте, камера отъехала"><br>
<sub><b>Холст.</b> Те же окна плавающими, камера отъехала: плоскость без краёв, свет,
стоящий на ней, и обои, едущие вместе с камерой.</sub></td>
</tr>
<tr>
...
<td width="50%"><img src="assets/shots/cube.jpg" alt="Куб рабочих столов: столы на гранях призмы"><br>
<sub><b>Куб рабочих столов.</b> Те же столы на гранях призмы, которую крутят мышью
(<code>plx-extra</code>).</sub></td>
</tr>
</table>
