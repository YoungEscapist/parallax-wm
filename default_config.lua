...
-- Перспектива в обзоре окон (Super+~, карточка «Открытые окна»): миниатюры
-- разворачиваются к центру, дальний край уходит вглубь и темнеет — обзор
-- становится вогнутой стеной окон вместо плоской карты. 0.0 — как раньше,
-- 1.0 — разворот до 35° у края карточки.
set{ overview_3d = 0.0 }
